            ...
            <div class="col-xs-12 col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<h3><b>Total Payment:</b> $<?php echo $price ?></h3>
					</div>
					<div class="panel-body">
						...
						<!-- Payment form -->
						<form action="submit.php?user_id=<?php echo $user_id ?>&p_id=<?php echo $p_id; ?>&b_id=<?php echo $b_id;?>&p_method=<?php echo $p_method;?>&price=<?php echo $price;?>" method="post" id="paymentFrm">
							...
							<div class="form-group">
								<label>EMAIL</label>
								<input type="email" name="email" id="email" class="field" placeholder="Enter Email" required="" autofocus="">
